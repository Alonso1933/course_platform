        ...
        <div class="lg:col-span-2">
            ...
            <div class="card mt-2">
                <div class="card-body flex text-gray-500 font-bold">
                    ...
                    @if ($this->next)
                        <a class="cursor-pointer ml-auto" wire:click="changeLesson({{$this->next}})">Siguiente tema</a>
                    @endif
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="flex items-center">
                    <figure>
                        <img class="w-12 h-12 object-cover rounded-full m-4 shadow" src="{{$course->teacher->profile_photo_url}}" alt="Prof. {{$course->teacher->name}}">
                    </figure>
